...
<div align="right" style="width: 335px; margin-left: 335px ;margin-bottom: 20px" >
 ...
 <div class="form-group" style="margin-right: 320px"  align="left">
    {!! Form::label('cat_name', 'Enter Name of Category:',['class'=>' col-md-4 col-form-label text-right '] ) !!}
          {!! Form::text('cat_name', null, ['class'=>'form-control col-md-8'])!!}
 </div>
 <div class="form-group" style="margin-right: 320px" align="left">
    {!! Form::label('cat_image', 'Image for Category:',['class'=>' col-md-4 col-form-label text-right '] ) !!}
    {!! Form::file('cat_image', null, ['class'=>'form-control col-md-8'])!!}
 </div>
 <br /><br /><br />
